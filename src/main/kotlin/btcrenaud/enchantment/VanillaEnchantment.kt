...
private val logger = Logger.getLogger("btcrenaud.enchantment.VanillaEnchantment")
...
enum class VanillaEnchantment(
    ...
    SWEEPING_EDGE(NamespacedKey.minecraft("sweeping_edge"), "Sweeping Edge"),
    ...
    LUNGE(NamespacedKey.minecraft("lunge"), "Lunge"),
    ;
