...
@Entry(
    name = "frozen_armor_action",
    description = "Slows and freezes the attacker when they strike you",
    color = Colors.BLUE,
    icon = "mdi:snowflake"
)
class FrozenArmorActionEntry(
    ...
    override fun ActionTrigger.execute() {
        ...
        EnchantmentSchedulers.runOnPlayer(player) {
            ...
            player.world.spawnParticle(org.bukkit.Particle.SNOWFLAKE, attacker.eyeLocation, 10, 0.4, 0.4, 0.4, 0.05)
        }
    }
}
